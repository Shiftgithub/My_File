...
<div class="container">
	...
	<div style="background-color:#a6dcef">
		...
		<div class="container"><br>
			<form action="ProcessingFormWithCgpaCalculator.php" method="POST">
				...
				<div class="row form-group">
					...
					<div class="col-10 text-white">
						<input type="radio" id="Spring" name="Semester"><label for="Spring">Spring</label>
                        <input type="radio" id="Summer" name="Semester"> <label for="Summer">Summer</label>
                        <input type="radio" id="Fall" name="Semester"> <label for="Fall">Fall</label></div>
				</div>
				<div class="row form-group">
